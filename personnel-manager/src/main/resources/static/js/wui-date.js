angular.module('wui.date',[]).directive('wuiDate', function() {
	...
	function fieldTemplate(scope, element, attr) {
		return(
			//span12 span11 为自定义
			'<div class="span12 wui-date wui-date" ng-app="wui.date">' +
			'<div class="wui-date-editor" ng-click="openPicker()">' +
			'<input class="span11 wui-input wui-input-block wui-date-input" type="text" placeholder="{{placeholder}}" ng-model="ngModel" autocomplete="off" ng-blur=checkDateFormat()>' +
